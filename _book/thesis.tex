...
\pagestyle{empty} % this removes page numbers from the frontmatter
  \begin{abstract1}
    ...
    \vspace{3em}
    \end{center} \hspace{-.15in} \begin{tabular}{ll} Title of Dissertation:    & {\large  THIS IS THE TITLE}\\ &                     {\large  OF YOUR DISSERTATION} \\ &                     {\large  ALL LETTERS SHOULD BE CAPITALIZED} \\ \ \\ &                          {\large  Your name} \\ &                           {\large Doctor of Philosophy, Year} \\ \ \\ Dissertation Directed by: & {\large  Professor X} \\ &               {\large  Department of Y} \\ \end{tabular}
    \vspace{3em}
...
\begin{titlepage1}
    ...
    \small\normalsize 
    \begin{center}
    \large{{THIS IS THE TITLE OF YOUR DISSERTATION \\ ALL LETTERS SHOULD BE CAPITALIZED}}\\ \ \\ \ \\ \large{by} \\ \ \\ \large{Your name} \ \\ \ \\ \ \\ \ \\ \normalsize Dissertation submitted to the Faculty of the Graduate School of the \\ University of Maryland, College Park in partial fulfillment \\ of the requirements for the degree of \\ Doctor of Philosophy \\ Year \end{center}
    \vspace{7.5em}
    
    \noindent Advisory Committee: \newline \indent Professor A, Chair/Advisor \newline \indent Dr.~B, Co-Advisor \newline \indent Professor C \newline \indent Professor D \newline \indent Professor E
\end{titlepage1}
\begin{copyright1}
    ...
    \renewcommand{\baselinestretch}{1} \small\normalsize
    \vspace{.5in}
    \begin{center} \large{\copyright \hbox{ }Copyright by\\ Your name \\ Year} \end{center}
    \vfill
    \newpage
\end{copyright1}
...
\tableofcontents
  ...
  \begin{loa}
    ...
    \vspace{3pt}
    \begin{tabular}{ll} UMD & University of Maryland \\ NIH & National Institutes of Health \end{tabular}
  \end{loa}
\newpage
